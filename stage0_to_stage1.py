...
if __name__ == "__main__":
    ...
    for record in records:
        ...
        # if it is not eeg signal, SKIP :D
        if 'ECG' in raw.ch_names or 'VNS' in raw.ch_names or 'LOC-ROC' in raw.ch_names:
            continue
        ...
        # if montage is not double banana, skip nahui
        ...
        # changing the year of the date to 2023, as they put the year 2076 in the dataset (what a joke ^^)
