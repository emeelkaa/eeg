...
for epoch in range(EPOCHS):
    ...
    if val_loss < best_loss:
        best_loss = val_loss
        early_stop_counter = 0
        torch.save(model.state_dict(), "best_channelnet.pth")
...
model.load_state_dict(torch.load("best_channelnet.pth"))
...
logging.info("Confusion matrix saved as 'cm_channelnet.png'")
